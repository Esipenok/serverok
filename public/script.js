...
async function refreshStats() {
    try {
        const [statsResponse, summaryResponse] = await Promise.all([
            fetch(`/api/stats?username=${adminCredentials.username}&password=${adminCredentials.password}`),
            fetch(`/api/stats-summary?username=${adminCredentials.username}&password=${adminCredentials.password}`)
        ]);
...
async function testSSHConnection() {
  try {
    const response = await fetch(`/api/ssh-test?username=${adminCredentials.username}&password=${adminCredentials.password}`);
    if (!response.ok) {
...
async function refreshServerStatus() {
  try {
    const response = await fetch(`/api/server-status?username=${adminCredentials.username}&password=${adminCredentials.password}`);
    if (!response.ok) {
...
async function refreshComplaints() {
  try {
    const response = await fetch(`/api/all-complaints?username=${adminCredentials.username}&password=${adminCredentials.password}`);
    if (!response.ok) {
...
async function refreshComplaintsStats() {
  try {
    const response = await fetch(`/api/complaints-stats?username=${adminCredentials.username}&password=${adminCredentials.password}`);
    if (!response.ok) {
